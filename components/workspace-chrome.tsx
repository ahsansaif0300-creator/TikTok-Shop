...
import { BrandBar, BrandMark, HarborMark } from "@/components/brand";
            ...
            <div className="flex h-16 items-center justify-between gap-3 px-4 sm:px-6">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="hidden min-w-0 sm:block">
                  ...
                  <p className="hidden text-xs text-muted lg:block">Real orders, catalog, settlements, and bank payouts.</p>
                </div>
              </div>
